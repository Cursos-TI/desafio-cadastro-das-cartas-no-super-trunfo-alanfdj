...
INSTRUÇÕES PARA COMPILAR E EXECUTAR O JOGO SUPER TRUNFO : 

1 - INSTALE O COMPILADOR GCC ATRAVÉS DO MINGW QUE PODE SER BAIXADO NA INTERNET.
2 - BAIXE E INSTALE O VSCODE.
3 - ABRA O VSCODE CRIE UM ARQUIVO NOVO COM A EXTENSÃO .c E COPIE E COLE O CODIGO QUE ESTÁ NO ARQUIVO DO REPOSITORIO GIT.
4 - PRESSIONE F6 E JOGO ESTARÁ COMPILADO E VOCÊ JÁ PODE EXECUTA-LO NA PARTE INFERIOR DO TERMINAL DO VSCODE.

COMO JOGAR ? 

AO INICIAR O JOGO DÁ DUAS OPÇÕES : 1 - INICIA E 2 - SAI DO JOGO.
LOGO APÓS SÃO APRESENTADAS AS CARTAS DISPONIVEIS E OS ATRIBUTOS QUE PODEM SER COMPARADOS.
